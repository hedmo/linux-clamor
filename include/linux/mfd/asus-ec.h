...
#define ASUSEC_SMI_ACTION(code) (ASUSEC_SMI_MASK | ASUSEC_OBF_MASK | (ASUSEC_SMI_##code << 8))
...
int devm_asusec_register_notifier(struct platform_device *dev, struct notifier_block *nb);
